...
1. Componentes	3
2. Introdução e motivação	3
3. Mini-mundo novo	3
4. Rascunhos básicos da interface (mockups)	4
4.2. Quais perguntas podem ser respondidas com o tema proposto?	5
a) O sistema proposto poderá fornecer quais tipos de relatórios e informações?	5
b) Crie uma lista com os 10 principais relatórios que poderão ser obtidos por meio do sistema proposto!	5
5. Modelo conceitual	5
5.1 Validação do Modelo Conceitual	6
5.2. Decisões de projeto	6
5.3. Descrição dos dados	6
6. Modelo lógico	6
8. Insert aplicado nas telas dos bancos de dados	7
8.1. Detalhamento das informações	7
8.2 INCLUSÃO DO SCRIPT PARA CRIAÇÃO DE TABELA E INSERÇÃO DOS DADOS	7
8.3 INCLUSÃO DO SCRIPT PARA EXCLUSÃO DE TABELAS EXISTENTES, CRIAÇÃO DE TABELA NOVAS E INSERÇÃO DOS DADOS	7
9. TABELAS E PRINCIPAIS CONSULTAS	8
9.2. CONSULTAS DAS TABELAS COM FILTROS WHERE (Mínimo 4)	8
9.3. CONSULTAS QUE USAM OPERADORES LÓGICOS, ARITMÉTICOS E TABELAS OU CAMPOS RENOMEADOS (Mínimo 11)	8
9.4. CONSULTAS QUE USAM OPERADORES LIKE E DATAS (Mínimo 12)	8
9.5. ATUALIZAÇÃO E EXCLUSÃO DE DADOS (Mínimo 6)	8
9.6. CONSULTAS COM JUNÇÃO E ORDENAÇÃO (Mínimo 6)	8
9.7 CONSULTAS COM GROUP BY E FUNÇÕES DE AGRUPAMENTO (Mínimo 6)	9
9.8 CONSULTAS COM LEFT E RIGHT JOIN (Mínimo 4)	9
9.9 CONSULTAS COM SELF JOIN E VIEW (Mínimo 6)	9
9.10 SUBCONSULTAS (Mínimo 3)	9
9.11 LISTA DE CÓDIGOS DAS FUNÇÕES E TRIGGERS	9
9.12 GERAÇÃO DE DADOS (MÍNIMO DE 100 MIL REGISTROS PARA PRINCIPAL RELAÇÃO)	9
9.13 Backup do Banco de Dados	10
9.14 APLICAÇÃO DE ÍNDICES E TESTES DE PERFORMANCE	10
11. Backup completo do banco de dados postgres	11
12. TUTORIAL COMPLETO DE PASSOS PARA RESTAURAÇÃO DO BANCO E EXECUÇÃO DE PROCEDIMENTOS ENVOLVIDOS NO TRABALHO PARA OBTENÇÃO DOS RESULTADOS	11
13. DIFICULDADES ENCONTRADAS PELO GRUPO	11
